...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "The Fusion of Two Cultures in Abou Youssef",
        },
        {
          type: "image",
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Alexandria Sea",
          price: "$15",
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-pizza-with-tomatoes-mushrooms-olives_141793-1392.jpg",
        },
        {
          id: "4",
          name: "Truffle Bliss",
          price: "$18",
          imageSrc: "http://img.b2bpic.net/free-photo/chef-holding-seafood-pizza-with-shrimp-mussels-calamari-squid-cheese_141793-2291.jpg",
        },
        {
          id: "5",
          name: "Four Seasons",
        ...
        },
        {
          ...
          name: "Veggie Royale",
          price: "$11",
          imageSrc: "http://img.b2bpic.net/free-photo/crispy-pizza-made-from-kiwi-fruit-banana_140725-7253.jpg",
        },
      ]}
      ...
      members={[
        {
          ...
          name: "Chef Marco",
          role: "Pizza Master",
          imageSrc: "http://img.b2bpic.net/free-photo/chef-white-uniform-prepare-pizzaa_1157-27033.jpg",
        },
        {
          id: "c2",
          name: "Chef Ahmed",
  ...
  <div id="gallery" data-section="gallery">
      ...
      features={[
        {
          title: "Pizza Tossing",
          description: "Authentic technique.",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-hand-sprinkling-flour-dough-cutting-board_23-2148361307.jpg",
          titleImageSrc: "",
          buttonText: "View",
        },
        {
          title: "Pasta Plates",
          description: "Chef favorites.",
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/indulgent-dessert-dark-chocolate-fudge-with-strawberries-generated-by-ai_188544-22763.jpg",
          titleImageSrc: "",
          buttonText: "View",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Sarah Ahmed",
          handle: "@sarah.a",
          testimonial: "Best pizza in El Agamy!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-modern-man_23-2147960990.jpg",
        },
        {
          id: "2",
          name: "John Doe",
          handle: "@johndoe",
          testimonial: "Authentic fusion, loved it.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-young-woman-white-shirt_1303-24912.jpg",
        },
        {
          id: "3",
          name: "Laila M.",
          handle: "@lailam",
          testimonial: "Perfect atmosphere for family.",
          rating: 4,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-portrait-young-smiling-man_171337-20064.jpg",
        },
        {
          id: "4",
          name: "Omar K.",
          handle: "@omark",
          testimonial: "Chef special is incredible.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-portrait-attractive-sucsessful-business-woman-posing-outdoor-wavy-hairs-white-elegant-jacket_273443-3218.jpg",
        },
        {
          id: "5",
          name: "Family Trip",
      ...
      faqs={[
        {
          ...
          content: "Yes, please book online.",
        },
        {
          id: "q2",
          title: "Is there parking?",
          content: "Parking available nearby.",
        },
        {
          id: "q3",
          title: "Are you family-friendly?",
          content: "Yes, we have high chairs.",
        },
      ]}
